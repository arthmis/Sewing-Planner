...
enum Effect: Equatable {
  case createProject
  case StoreNewSection(section: SectionInputRecord)
  ...
  case SaveSectionItemTextUpdate(item: SectionItem, sectionId: Int64, projectId: Int64)
  ...
  case SaveSectionItemUpdate(SectionItemRecord, sectionId: Int64, projectId: Int64)
  ...
  case GenerateImagesPreview(ProjectImageRecord, projectId: Int64)
